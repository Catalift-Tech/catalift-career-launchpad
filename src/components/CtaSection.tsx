    ...
    <section id="get-started" className="py-20 bg-[#03045E] text-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Start Your Journey With Expert Guidance</h2>
            <p className="text-lg text-blue-100 mb-8">
              Join thousands of  students across India who are accelerating their careers with personalized mentorship and skill-building opportunities.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm text-blue-100">Joined by 2,500+ students</span>
              </div>
            </div>
          </div>
